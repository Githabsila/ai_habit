...
try {
    // Та же причина "прогружается заново при пролистывании", что и в
    // основном app.js: без этого вертикальный свайп в чате может
    // трактоваться Telegram как жест сворачивания/закрытия.
