...
PRAISE_A = [
    # Улучшение по фидбеку: экран празднования серии и так весь в огне
    # (иконка, орбита анимации, полоса из 7 дней) — если ещё и текст снизу
    # заканчивается на 🔥, получается "слишком много огоньков" на одном
